...
type RegionView struct {
	...
	// Chill is how cold this block is on average (stage 85), nought for the
	// ordinary world. It is a summary: since #135 the weather is a map of its
	// own at its own grain, and what a body pays is read off that.
	Chill float64
}
